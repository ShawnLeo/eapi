			...
			<div class="header-content clearfix">
				...
				<div class="head-user fr">
					<li class="head-user" v-if="state.user.authId">
						<span class="title" growing-ignore="true"><Avatar icon="ios-person"/>   {{state.user.authId}} <Icon
							type="arrow-down-b"></Icon></span>
						<ul class="head-user-list">
							<li><a href="javascript:void(0);" @click="logout" class="btn_logout">
