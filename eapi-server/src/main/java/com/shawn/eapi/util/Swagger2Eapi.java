package com.shawn.eapi.util;

import com.google.common.collect.Lists;
import com.shawn.eapi.consts.ParamInConsts;
import com.shawn.eapi.consts.ResponseInConsts;
...
import com.shawn.eapi.model.Parameters;
import com.shawn.eapi.model.Properties;
...
import static com.shawn.eapi.util.JpaSpecUtils.eq;
import static com.shawn.eapi.util.JpaSpecUtils.in;
import static com.shawn.eapi.util.JpaSpecUtils.merge;
...
public class Swagger2Eapi {
    ...
    public void tagSetToTagList(List<Tag> tags, String projectId, String creater, String createrUserName) {
        ...
        List<com.shawn.eapi.entity.Tag> newTags = Lists.newArrayList();

        tags.forEach((tag) -> {

            com.shawn.eapi.entity.Tag newTag = new com.shawn.eapi.entity.Tag();
...
//                _interface.setRequestType();
                ...
                List<com.shawn.eapi.entity.Tag> tags = tagRepository.findAll((Specification<com.shawn.eapi.entity.Tag>) (root, query, cb) -> cb.and(merge(
